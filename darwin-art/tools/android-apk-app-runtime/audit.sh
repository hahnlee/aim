...
expected='apk-app-runtime: package=dev.darwinart.simple application=android.app.Application activity=dev.darwinart.simple.MainActivity launch_component=dev.darwinart.simple.MainActivity screen_orientation=-1 descriptor=Ldev/darwinart/simple/MainActivity; activities=dev.darwinart.simple.MainActivity=0x1030241 activity_windows=dev.darwinart.simple.MainActivity=-1:0x0:1 activity_aliases=none info_activities=none services=dev.darwinart.simple.ImageService>dev.darwinart.simple>1>none>0>1,dev.darwinart.simple.DisabledService>dev.darwinart.simple>0>none>0>0 receivers=none service_metadata=none providers=none application_metadata=none permissions=android.permission.ACCESS_NETWORK_STATE version_code=0 version_name= theme=0x1030241 target_sdk=35 debuggable=0 has_code=1 hardware_accelerated=1 supports_rtl=0 activity_hardware_accelerated=1 label=Darwin ART APK label_res=0x0 icon=none icon_res=0x0 dex=apk-1 manifest_schema=8 native=0 native_root=none'
