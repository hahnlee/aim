...
pub const HEADLESS_ADAPTER_SOURCES: &[&str] = &[
    ...
    "sensor/sensor_ndk.cc",
    "sensor/system_sensor_manager_jni.cc",
    ...
    "../runtime/framework/pm/installd/installd_jni.cc",
    "../runtime/framework/system/host_command_jni.cc",
    ...
    "../runtime/framework/display/host_display_facts_jni.mm",
    ...
    "security/verity_utils_jni.cc",
    "security/selinux_jni.cc",
    "security/security_log_jni.cc",
    "process/identity_jni.cc",
    "content/overlay_config_jni.cc",
    "content/strict_jar_file_jni.cc",
